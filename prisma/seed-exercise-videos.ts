...
const VIDEOS: Record<string, { general: Pick; female?: Pick }> = {
  // --- Bodyweight / home movements (seed-bodyweight.ts). Verified through
  // YouTube oEmbed the same way as everything above.
  "Wide Push-Up": { general: { id: "m3FTgWtJsFE", title: "How To Wide-Hands Pushup | Nuffield Health", channel: "Nuffield Health" } },
  "Knee Push-Up": { general: { id: "lFR1GWy1Dcs", title: "The Knee Push Up | How To Perform Without Shoulder Pain", channel: "Dr. Carl Baird" }, female: { id: "__71lgdtiB8", title: "How To Properly Do A Modified Push-Up On Knees - Strength Exercises - Wellen", channel: "Wellen" } },
  "Towel Biceps Curl": { general: { id: "p8z4fhUWhP4", title: "How to Train the Biceps Without Weights - Towel Bicep Curls", channel: "Mike | J2FIT Strength & Conditioning" }, female: { id: "kx_CogPXDJ0", title: "Towel Biceps Curl Arm Exercise | Fitness", channel: "FITNESS Magazine" } },
  "Isometric Towel Curl": { general: { id: "2wxdLcxQjHI", title: "Isometric Towel Bicep Curl", channel: "ForeverStrong® Fitness" } },
  "Chair Dip": { general: { id: "AWz_7B1cch0", title: "How To Properly Do Tricep Chair Dips - 3 Common Mistakes", channel: "Coach Nick Fitness" }, female: { id: "rjdpMVtMehw", title: "How to do a Triceps Dip on a Chair at Home", channel: "Get Strong with Emily" } },
  "Diamond Push-Up": { general: { id: "J0DnG1_S92I", title: "How To: Diamond Push-Up", channel: "ScottHermanFitness" }, female: { id: "1KKU5_p7oH8", title: "How To Diamond Push Up With Krissy Cela", channel: "EvolveYou" } },
  "Towel Wring": { general: { id: "1mRNF7ZgY7M", title: "Wrist Strengthening - Wringing the towel", channel: "Physio by Design" } },
  "Fingertip Push-Up": { general: { id: "i77pgUexl5s", title: "How to do Finger Tip Push Ups! (Great Exercise for STRONG Hands!)", channel: "Tykato Fitness" } },
  "Reverse Crunch": { general: { id: "5du-BoCjxp8", title: "STOP Doing Reverse Crunches Like This - 3 Common Mistakes To AVOID", channel: "Coach Nick Fitness" }, female: { id: "ue6j6k0Vgbc", title: "Reverse Crunch | Core & Ab Strength Exercise Tutorial", channel: "Lift With Michelle - Exercise Form Tutorials" } },
  "Hollow Hold": { general: { id: "jLxtFNO0r50", title: "How to Do a Hollow Hold: A Guide from Physical Therapists", channel: "Hinge Health" }, female: { id: "qU0r6449do4", title: "Hollow Hold", channel: "Pamela Gagnon - Gymnastics Skills & Drills" } },
  "Wall Squat Hold": { general: { id: "cWTZ8Am1Ee0", title: "How to Do a Wall Sit Exercise | 30 Seconds | MedBridge", channel: "Medbridge" }, female: { id: "JaZNYM3zAP0", title: "How To Do a Wall Sit | The Right Way | Well+Good", channel: "Well+Good" } },
  "Split Squat": { general: { id: "PmcMG7iSjpo", title: "The Split Squat w/ Dr. Carl Baird | Strength Training For Beginners", channel: "Dr. Carl Baird" }, female: { id: "4J3WPBh_F0Q", title: "Split Squat - Modern Woman's Guide to Strength Training", channel: "Girls Gone Strong | Women's Health & Fitness" } },
  "Side-Lying Hip Abduction": { general: { id: "-rDiQXjeXO0", title: "Foolproof Guide to Side Lying Hip Abduction", channel: "[P]rehab" }, female: { id: "UYE-Sc_0ggE", title: "Side Lying Leg Raise-HIp Abduction/Adduction", channel: "Michelle Roots Fitness & Nutrition Coach" } },
  "Standing Hip Adduction": { general: { id: "7QYaJFppQFE", title: "Hip adduction standing", channel: "Rehab My Patient" }, female: { id: "SO3uz2viSVk", title: "Standing Hip Adduction - Ask Doctor Jo", channel: "AskDoctorJo" } },
  "Jumping Jack": { general: { id: "uLVt6u15L98", title: "How to do a Jumping Jack | Proper Form & Technique | NASM", channel: "National Academy of Sports Medicine (NASM)" }, female: { id: "9gDfNpzytLo", title: "How to do a proper JUMPING JACK", channel: "Jenny Schatzle" } },
  "High Knees": { general: { id: "sTvekaq6vOU", title: "How To Do High Knees", channel: "PureGym" }, female: { id: "QIwxSeKpHtI", title: "How to perform HIGH Knees", channel: "Get Healthy U - with Chris Freytag" } },
  "Burpee": { general: { id: "NCqbpkoiyXE", title: "How To Burpee | Nuffield Health", channel: "Nuffield Health" }, female: { id: "Ttdn5ExPIIA", title: "Safe Burpee - Modern Woman's Guide to Strength Training", channel: "Girls Gone Strong | Women's Health & Fitness" } },
  "Mountain Climber": { general: { id: "De3Gl-nC7IQ", title: "How to do Mountain Climbers Exercise the RIGHT way.", channel: "Nick Tumminello - Trainer of Trainers" }, female: { id: "BhERlhtzQ1s", title: "How To Do Mountain Climbers with Proper Form", channel: "Get Healthy U - with Chris Freytag" } },
  "Bodyweight Shrug": { general: { id: "r0GtfUEbvyE", title: "Bodyweight Shrug - Shoulder Strengthening Exercise", channel: "Lifestyle Fitness Studio" } },
  "Prone Swimmer": { general: { id: "q8kPDJcfmlA", title: "How To Do Prone Swimmer Exercise for Shoulder Mobility - Tangelo Health", channel: "Tangelo - Seattle Chiropractor + Rehab" }, female: { id: "csPd3HMkRpQ", title: "Prone Swimmer - Ask Doctor Jo", channel: "AskDoctorJo" } },
  "Single-Leg Glute Bridge": { general: { id: "b1zTCyGJXCQ", title: "Single Leg Glute Bridge Exercise | How To Perform And Common Mistakes", channel: "Dr. Carl Baird" }, female: { id: "nat5dN0Kuao", title: "How To Do The Single-Leg Glute Bridge Like a Pro | Katie Callaway", channel: "Onnit" } },
  "Glute Kickback": { general: { id: "BNDw4ciQoQI", title: "Glute Kickbacks | Nuffield Health", channel: "Nuffield Health" }, female: { id: "O5-ROTyo2dA", title: "How to do a Banded Glute Kickback", channel: "Get Strong with Emily" } },
  "Single-Leg Romanian Deadlift": { general: { id: "6pEL3KxnlEo", title: "How to do a Single-Leg Romanian Deadlift", channel: "National Academy of Sports Medicine (NASM)" }, female: { id: "gPnUTh0k0kc", title: "How to Do a Single-Leg Romanian Deadlift", channel: "Girls Gone Strong | Women's Health & Fitness" } },
  "Wall Angel": { general: { id: "4Fm0gLIeVcU", title: "How To Perform The Wall Angel Exercise For Better Posture And Less Shoulder Pain", channel: "Dr. Carl Baird" } },
  "Bear Crawl": { general: { id: "disJ_lTAmAg", title: "How To Perform The Bear Crawl Exercise | Safely Building Core Strength For Less Joint Pain", channel: "Dr. Carl Baird" }, female: { id: "Gb2e9edK8a4", title: "How To Do A Bear Crawl With Proper Form", channel: "Get Healthy U - with Chris Freytag" } },
  "Inchworm": { general: { id: "rmCOifHCDKE", title: "Inchworm | Nuffield Health", channel: "Nuffield Health" }, female: { id: "TPvAZNmzc2w", title: "How to Do an Inch Worm Exercise | Sleek/Strong With Rachel Cosgrove", channel: "LivestrongWoman" } },
